...
window.MM = {
  ...
  models: [
    ...
    {id:"c08",cat:"动机与行为",cn:"旁观者效应",en:"Bystander Effect",principle:"在场旁观者越多，任何一个人出手相助的概率反而越低——责任被人群“分摊”稀释了（责任分散）。",scope:"仅适用于：需要有人主动出手的公共求助/紧急情境；不适用于责任已明确指派给某人的场合。",use:"求助时别对着人群喊，要点名某一个人下指令（如“穿蓝衣服的你，去叫救护车”）；自己也别假设“总会有人管”。",src:"Darley & Latané (1968), J. of Personality and Social Psychology 8(4):377–383",disc:"认知与心理",func:"驱动行为",general:4,scope_type:"特例",proven_domains:[],example:"「假装癫痫实验」受试者以为只有自己听到有人发病时，85%会去帮；以为还有4人也在听时只剩31%——人越多越互相指望。→ 求助要点名到具体某一个人。",added:"2026-06-12",status:"candidate"},
    {id:"c09",cat:"复杂系统与网络",cn:"路径依赖",en:"Path Dependence",principle:"早期某个（可能纯属偶然的）选择，会因“越用越有优势”和高切换成本被锁定，哪怕后来有更优方案也难以改弦更张。",scope:"仅适用于：存在“递增收益+高切换成本”的标准/技术/制度演化；不适用于可低成本随时切换、无锁定效应的选择。",use:"先分清现状是“历史偶然被锁死”还是“真最优”；做奠基决策时重视早期选择（它会自我强化）；想颠覆就找切换成本的突破口。",src:"David (1985), 《Clio and the Economics of QWERTY》, American Economic Review 75:332–337",disc:"复杂系统与网络",func:"看懂系统",general:4,scope_type:"特例",proven_domains:[],example:"「QWERTY 键盘」当初为减少打字机卡键而故意打乱常用字母，后来卡键早不是问题、也出现了更快布局，但全世界已被“人人都会用”锁死、换不动了。→ 别默认“现在通行的”就是“最好的”。",added:"2026-06-13",status:"candidate"},
    {id:"c10",cat:"动机与行为",cn:"服从权威",en:"Obedience to Authority",principle:"在被认可的权威下令时，普通人会做出违背自己良心的行为——把责任推给“上面让我做的”。",scope:"仅适用于：存在被认可的权威、且权威为行为“背书担责”的情境；不适用于无权威或责任明确在己的场合。",use:"被权威要求做可疑之事时，刻意把责任拉回自己（“出了事，签字的是我”）；设计制度时别让“服从命令”成为免责借口。",src:"Milgram (1963), 《Behavioral study of obedience》, J. of Abnormal and Social Psychology 67:371–378",disc:"认知与心理",func:"驱动行为",general:4,scope_type:"特例",proven_domains:[],example:"「米尔格拉姆电击实验」普通受试者在实验员一句“请继续”的催促下，竟有65%一路把（伪装的）电压加到致命的450伏——只因“是权威让我做的”。→ 被命令做坏事时，先把责任拉回自己。",added:"2026-06-21",status:"candidate"},
